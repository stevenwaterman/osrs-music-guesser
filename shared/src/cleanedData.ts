...
export const finishedData: Record<string, { title: string; file: string; polygons: Polygon[] }> = {
  ...
  "Lament of Meiyerditch": {
    ...
    "polygons": [...myrequeLaboratories, meiyerditchHideout, oldManRal,
    {
      "coordinates": [
        [
          3606,
  ...
  "Theme": {
    "title": "Theme",
    "file": "Theme",
    "polygons": [baxtorianWaterfallDungeon,
      {
        "coordinates": [
          [
            2560,
...
function song(name: string, ...polygons: Polygon[]): Record<string, { title: string; file: string; polygons: Polygon[] }> {
  return {
    [name]: {
      title: name,
      file: name,
